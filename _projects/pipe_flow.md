...
In the figures above, you can see some of the processed PIV data for laminar pipe flow. The figure on the right shows the flow velocity profile at an upstream and downstream location in the pipe. In the upstream case, we see a relatively blunted flow profile, and in the downstream case, we begin to see the parabolic profile expected of fully-developed Poiseuille flow. Although our glass pipe was approximately 6 feet long, future iterations of this experiment will benefit from even longer pipe sections, thereby ensuring fully developed flow upon the fluid exiting the pipe.
